...
fig = px.line_3d(trace.df, x='x', y='y', z='z',
                 color='color', animation_frame='step', **kwargs)

# for step in fig.layout['sliders'][0]['steps']:
#     step['args'][1]['frame']['range_x'] = kwargs['range_x']
#     step['args'][1]['frame']['range_y'] = kwargs['range_y']
#     step['args'][1]['frame']['range_z'] = kwargs['range_z']

fig.show()
fig.write_html('animation_tmp.html')
